...
export const metadata: Metadata = {
  ...
  description:
    "Master Hong Scaffolding Works offers professional scaffolding services in Hong Kong with over 20 years of experience. Safe, reliable, and fairly priced scaffolding solutions.",
  keywords:
    "scaffolding, Hong Kong, construction, safety, professional scaffolding, 搭棚, 香港, 建築, 安全",
  ...
  openGraph: {
    title: "Master Hong Scaffolding Works - Professional Scaffolding Services",
    description:
      "Professional scaffolding services in Hong Kong with over 20 years of experience",
    type: "website",
    locale: "zh_HK",
