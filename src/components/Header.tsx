  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 bg-gradient-to-b from-[#FFFBB5] to-[#E0B700] backdrop-blur-md">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center overflow-hidden rounded-lg bg-transparent">
                <Image
                  src={companyInfo?.logo || "/scaffolding-logo.png"}
                  alt={companyInfo?.name || "康師傅搭棚公司"}
                  width={100}
                  height={100}
        ...
        <div
          className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out border-t border-gray-200 bg-gradient-to-b from-[#FFFBB5] to-[#E0B700] ${
            isMobileMenuOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"
          }`}
        >
          <div
            className={`px-4 py-3 space-y-3 transform transition-all duration-300 ease-in-out ${
