  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 bg-gradient-to-b from-[#FFFBB5] to-[#E0B700] backdrop-blur-md">
        ...
        >
          <div className={`px-4 py-3 space-y-3 transform transition-all duration-300 ease-in-out ${
            isMobileMenuOpen
              ? 'translate-y-0'
              : '-translate-y-4'
          }`}>
            ...
            <div className={`pt-2 border-t border-gray-200/50 transform transition-all duration-300 ${
              isMobileMenuOpen
                ? 'translate-x-0 opacity-100'
                : '-translate-x-4 opacity-0'
            }`}
